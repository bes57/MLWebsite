---
title: "Kalshi Analysis 2025 (Updated May)"
...
```
<br>
Holy shit. This is surprising. The previous profit figure above already takes fees into account, but still. It's clear that these minimal fees have built up for me over time, but it also shows how Kalshi remains profitable. 
...
Of course, this isn't very scientific; 5,000 was a guesstimate and I'm also assuming everyone else is paying fees at the same rate. The funny thing is that I actually believe I'm paying fees at a lesser rate than others. My market making/arbitrage strategies are almost all based on resting orders as opposed to immediately clearing orders, and resting orders incur smaller fees than clearing orders. AND we're not accounting for the *LARGE* majority of traders that are trading in smaller volume than me. That would suggest that Kalshi's total revenue in 2025 is a much, much higher number, but I digress. 

Another quick sidepoint: this helps makes sense as to why the Kalshi team is so responsive. I've submitted a few tickets to customer support and they've always surprised me with how quickly they responded. If 5,000 people are generating them 8-figures in fees, then it makes sense that they would coddle, encourage, and care for them as much as possible. Besides, the people who care enough to submit tickets and complain are usually high-volume traders. 
...
Also, regarding weekly trends, I view my Kalshi trading rate as having a direct association with how much free time and energy I have that day. Higher trading on weekends as well as Mondays being slow corroborates this theory.  
...
```
<br>
Ok! We're back in business. As a quick disclaimer, the "ticker" variable is the ID for the market that the trade took place in. I know the "ticker" ID can be difficult to understand without context, but I can use them to recall what these trades were.
