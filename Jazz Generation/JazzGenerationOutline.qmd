...
$|\ \text{C}\ |\ \text{Am}\ |\ \text{F}\ |\ \text{G}\ |$. What this means is that the first bar is in the key of C, the second in A minor, etc. This is simply just a *framework*. Jazz musicians then take these progressions and play over them. This means they're constantly aware of what bar they're in within the progression and what key corresponds to the current bar. Then, they improvise their melodies or perform they're comping (short for "accompanying", meaning to provide background harmonics to outline the progression) all based on the current key of the progression. 
